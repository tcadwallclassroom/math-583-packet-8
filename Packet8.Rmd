...
Shifting our perspective a little bit: We are examining whether or not the variable of "hospitalization event" is *independent* of the variable of "treated with ivermectin". In the null hypothesis, these variables are, in fact, independent: the probability of having an event is the same for those treated with ivermectin as those treated with a placebo. 
